...
queue_t threadsReady;		// Threads that are ready to process
queue_t threadsRunning;	// Threads that are running at processor
queue_t threadsExited;		// Threads that are done running / blocked

static queue_t threadQueue; // Global queue to manage all threads

static struct uthread_tcb *currentThread;
